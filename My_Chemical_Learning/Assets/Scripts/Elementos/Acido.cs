...
public class Acido : MonoBehaviour, IElemento //el script se encuentra en el prefab del mismo nombre y es el que dispara el jugador
{
    ...
    { 
        ...
        bool esEnemigo = otro.CompareTag("Oxidee"); //si choca con oxidee
